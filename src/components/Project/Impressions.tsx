...
const Impressions = ({ onChainProject, firstPendingMilestone, projectInMilestoneVoting, setOpenVotingList }: any) => {
                                ...
                                <div className='text-xl text-content flex flex-wrap items-center'>
                                    {
                                        firstPendingMilestone !== undefined &&
                                            ...
                                            : <>{
                                                milestone.is_approved
                                                    ? (<p className='text-lg cursor-pointer !text-content-primary'>Completed</p>)
                                                    : <p className='text-gray-500 text-opacity-30 cursor-pointer'>Pending</p>
                                            }</>
                                    }
                                </div>
                            </div>
