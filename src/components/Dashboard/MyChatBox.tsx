...
import { Chat, Channel, ChannelList, MessageInput, MessageList, Thread, Window, useChannelStateContext, useChatContext, ChannelProps } from 'stream-chat-react';
import { DefaultStreamChatGenerics } from 'stream-chat-react/dist/types/types';
import { useRouter } from 'next/router';


function DashboardChatBox({ client, filters }: { client: StreamChat; filters: object }) {
