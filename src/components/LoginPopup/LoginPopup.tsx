...
import { CircularProgress, Dialog, IconButton, InputAdornment, OutlinedInput } from '@mui/material';
...
import Register from '../SignUpComponents/Register';
import Web3WalletModal from '../WalletModal/Web3WalletModal';
...
const LoginPopup = ({ visible, setVisible, redirectUrl }: LoginModalProps) => {
    ...
    return (
        <Dialog
            PaperProps={{ className: 'rounded-2xl !mx-2 lg:mx-0 max-h-full' }}
        ...
        >
            <div className='relative'>
...

                {
                    showSignup
                        ? (
                            <Register redirectUrl={redirectUrl} setShowSignup={setShowSignup} />
                        )
                        : (
