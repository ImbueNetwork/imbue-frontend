            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-3 items-center">
                ...
                {milestone.state === "Open for voting" ? (
                  <div className="flex items-center ml-4 text-primary font-bold">
                    <div className="w-4 h-4 bg-primary rounded-full mx-3"></div>{" "}
                    {milestone.state}
                  </div>
                ) : (
                  <span className="ml-4 -text--theme-secondary font-bold">
                    {milestone.state}
                  </span>
                )}
                ...
                {expandMilestone === index ? (
                  <button
                    className="rounded-full text-white bg-[#411dc9] w-7 h-7 flex items-center justify-center"
                    onClick={() => setExpand(-1)}
                  >
                    -
                  </button>
              ...
              <div className="mt-5">
                <h3 className="mt-3">
                  ...
                  <span className="primary-text font-bold">
                    {milestone.fundPercent}%
                  </span>
                </h3>
                <h3 className="mt-1">
                  Funding to be released{" "}
                  <span className="primary-text font-bold">
                    ${milestone.fundAmound}USD
                  </span>
                </h3>
                <p className="mt-5">{milestone.description}</p>
                {milestone.state === "Open for voting" && (
                  <button className="primary-btn in-dark w-button mt-6">
                    Vote
                  </button>
                )}
              </div>
