            ...
            <div className="pt-60">
                <div className="flex flex-col lg:items-center gap-5 lg:gap-16 w-full">
                    <div className="w-full flex flex-col gap-4 pb-8 px-24 bg-theme-grey-dark rounded-xl border border-light-white relative">
                        <div className='w-fit'>
                            <UploadImage setUser={setUser} user={user} isEditMode={isEditMode} />
                        </div>
                        ...
                        <BiEdit onClick={() => setIsEditMode(!isEditMode)} className='absolute top-5 right-5 cursor-pointer' size={30} color='#b2ff0b' />
                        ...
                        {isEditMode ? (
                            ...
                            <>
                                <div className="bio">
                                    ...
                                    Welcome to a vibrant and multiple award-winning telecommunications service provider. Our aim is to bring people and businesses together in what we do best, by offering mobile and fixed services, broadband connectivity and IPTV services to people, homes and businesses. The Blockchain world has never been more exciting than right now. But in this fast-growing space, finding top talent and the perfect project can be tough | Cryptocurrency | Blockchain | Ethereum | Web3 | Smart Contract | DApps | DeFi | Solidity | Hyperledger | Polkadot  Rust | C | C ++ | C# | Python | Golang | Java | Javascript | Scala | Simplicity | Haskell |
                                </div>
                            </>
                        )}
                        ...
                        <div className='flex gap-14 items-center'>
                            <p className='w-24 font-bold text-xl'>Website :</p>
                            {
                                isEditMode
                                    ...
                                    : <span className='text-primary'>https://www.behance.net/abbioty</span>
                            }
...
export const getServerSideProps = async (context: any) => {
    ...
    try {
        ...
        if (browsingUser) {
            return { props: { isAuthenticated: true, browsingUser, initUser: initUser || {} } };
        }
    } catch (error: any) {
        console.error(error);
    }
